...
\subsection{Vector ordenat (o \textit{Sorted Vector})}
L'estructura de dades més simple i coneguda. En aquest cas s'emmagatzemarà cada paraula dins una posició del vector. Per tant, i mirant-ho des de termes del llenguatge C++, sempre es parlarà d'un vector de paraules (o \textit{string}).\par
...
\textbf{He trobat una extensió per a representar arbres, per si la voleu fer servir, podeu fer arbres a partir del que he trobat d'exemple}
\begin{center}
    \begin{forest}
        [TP
            [DP [D\\the] [NP[N\\man] ] ]
...
\subsection{Doble Hash}




\subsection{Filtre de Bloom}

\subsection{Classe SuperSopa}


\section{Implementació de les classes}
\subsection{Vector ordenat}
\subsection{Trie}
\subsection{Filtre Bloom}
\subsection{Taula Hash}

\section{Funcionament del programa principal \textit{main.cc}}



\section{Anàl·lisi d'agorismes}
...
Per acabar d'explicar bé l'algorisme, mirarem com funcionen les cerques de la primera i l'última ocurrència.
\paragraph{\textit{firstOcurrence}} 


\paragraph{\textit{lastOcurrence}}
...
\section{Anàl·lisi dels resultats}
